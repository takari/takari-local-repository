...
import io.tesla.aether.concurrency.DefaultFileLockManager.IndirectFileLock;
...
public class DefaultFileLockManagerTest
{
    ...
    @Test
    public void testSameThreadMultipleLocksReadRead()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
    ...
    @Test
    public void testSameThreadMultipleLocksWriteWrite()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
    ...
    @Test
    public void testSameThreadMultipleLocksWriteRead()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
    ...
    @Test
    public void testSameThreadMultipleLocksReadWrite()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
    ...
    @Test
    public void testAcquiredLockDoesNotPreventLockedFileToBeDeleted()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
    ...
    @Test
    public void testWaitingForAlreadyLockedFileToBeReleasedMustOnlyBlockCurrentThread()
        throws Exception
    {
    ...
    @Test
    public void testMultipleManagerInstancesShareTheSameLockTable()
        throws Exception
    {
        File file = TestFileUtils.createTempFile( "" );
        ...
        IndirectFileLock lock1 = (IndirectFileLock) manager.readLock( file );
        IndirectFileLock lock2 = (IndirectFileLock) manager2.readLock( file );
